...
const cardData = [
  { imageSrc: '/image/wes.png', title: 'علاج الوسواس القهري', description: 'تعريف : الوسواس القهري هو اضطراب نفسي يتميز بأفكار متكررة وغير مرغو فيها وسلوكيات قهرية يشعر الشخص بأنه مضطر لأدائها.: تشمل غسل اليدين المفرط، التدقيق المتكرر، الأفكار المتكررة عن النظافة أو النظام، والشعور بالقلق المستمر.' },
  ...
  return (
    <div style={backgroundStyle}>
      <div className="flex justify-center">
        <img src='./image/titre.png' alt="Title" />
      </div>
